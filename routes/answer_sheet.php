...
Route::middleware(['auth','admin'])->group(function () {
    ...
    Route::get("/answer_sheet/edit/{answer_sheet}", [\App\Http\Controllers\AnswerSheetController::class, "edit"])->name("answer_sheet.edit");
    Route::post("/answer_sheet/update/{answer_sheet}", [\App\Http\Controllers\AnswerSheetController::class, "update"])->name("answer_sheet.update");
